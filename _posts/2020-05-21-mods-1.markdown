...
excerpt: How to inject mods into a Unity game using some tech tricks including game and engine libraries modification, DLL input address table hooking, and Mono Runtime hijacking.
---
