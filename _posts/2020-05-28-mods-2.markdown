...
excerpt: "How to write a mod for Unity game using C#, a decompiler and Harmony, a powerful modding library used in RimWorld, Battletech, Cities: Skylines and many other games"
---
...
To protect the TimeTracker from garbage collection we need to either attach it to a scene or call DontDestroyOnLoad(...). The latter is easier.
