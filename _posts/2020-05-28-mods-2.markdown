...
SingleStartInit means that the mod is initialized once on the game start. The other option is DynamicInit which makes a mod disableable and enableable in runtime.
